    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body">
            ...
            <div class="title-header title-header-1">
                <h5>All Lesson Notes</h5>
                <form class="d-inline-flex">
                    <a href="add-new-lesson-note.php" class="align-items-center btn btn-theme">
            ...
            $teacherRs = MySQL::search("SELECT *, teacher_has_subject.id as ths_id  FROM teacher_has_subject JOIN subject s on teacher_has_subject.subject_id = s.id WHERE teacher_email = '" . $_SESSION['teacher']['email'] . "'");
                                        ...
                                        <div>
                                            <div class="table-responsive table-desi">
                                                <table class="user-table table table-striped all-package">
                                                    ...
                                                    $lnRs = MySQL::search("SELECT * FROM lesson_notes WHERE teacher_has_subject_id = '" . $teacherData['ths_id'] . "'");
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <ul>
                                                                    ...
                                                                    <li>
                                                                        <button onclick="deleteLessonNote('<?= $lnData['id'] ?>')"
