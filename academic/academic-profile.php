                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                ...
                                                <img style="height: 200px;"
                                                     src="../<?= ($academicData['profile_img'] != '') ? $academicData['profile_img'] : "assets/images/profile/user.png" ?>"
                                                     id="academic-profile-img-tag">
                                                <div class="mt-3">
                                                    <input type="file" id="profile-img" class="d-none" accept="image/*"
                                                           onchange="updateAcademicProfileImg()">
                                            ...
                                            <div class="accordion" id="accordionExample">
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                                        ...
                                                        <div class="accordion-body">
                                                            <!--Form Starts-->
                                                            <form id="academic-reset-pass-form"
                                                                  class="theme-form theme-form-2 mega-form"
                                                                  onsubmit="resetAcademicPassword(event)">
                                                                <div class="row">
