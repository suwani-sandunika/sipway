...
<head>
    ...
    <title>Sipway - Student Dashboard</title>
                        ...
                        <div class="b-b-danger border-5 border-0 card o-hidden">
                            <div class=" custome-2-bg  b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body p-0">
                                        <span class="m-0">No of Subjects</span>
                                        <h4 class="mb-0 counter">
                                            <?= MySQL::search("SELECT * FROM subject")->num_rows ?>
                    ...
                    <div class="col-sm-6 col-xxl-3 col-lg-6">
                        <div class="b-b-secondary border-5 border-0  card o-hidden">
                            <div class=" custome-3-bg b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body p-0">
                                        <span class="m-0">No of Assignments</span>
                                        <h4 class="mb-0 counter">
                                            <?= MySQL::search("SELECT * FROM assignments WHERE batch_id = '" . $_SESSION['student']["batch_id"] . "'")->num_rows ?>
                            ...
                            <div class=" custome-4-bg b-r-4 card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body p-0">
                                        ...
                                        <h4 class="mb-0 counter">
                                            <?= ($_SESSION['student']["payment_status"] == 1) ? "Paid <i class='fa fa-check-circle text-success'></i>" : "Not Paid" ?>
                                            <span class="badge badge-light-success grow"><?= ($_SESSION['student']["payment_status"] == 0) ? $_SESSION['student']['trial_period'] : "" ?></span>
                                        </h4>
                                    </div>
                            ...
                            <div class="card o-hidden card-hover">
                                <div class="card-header border-0">
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="card-header-title">
                                            <h4>Productivity of Lectures</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body pt-0">
