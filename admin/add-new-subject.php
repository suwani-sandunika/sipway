...
<head>
    ...
    <title>Sipway - Add New Subject</title>
                                        ...
                                        <div class="tab-content" id="pills-tabContent">
                                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                                                <form class="theme-form theme-form-2 mega-form"
                                                      id="subject-register-form"
                                                      onsubmit="registerSubject(event)">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-lg-2 col-md-3 mb-0">Subject
                                                                Name</label>
                                                            <div class="col-md-9 col-lg-10">
                                                                <input class="form-control" type="text" name="sub-name">
                                                            </div>
                                                        </div>

                                                        <div class="mb-4 row align-items-center">
                                                            <label class="form-label-title col-lg-2 col-md-3 mb-0">Year</label>
                                                            <div class="col-md-9 col-lg-10">
                                                        ...
                                                        <div class="mb-4">
                                                            <button type="submit" class="btn btn-primary"
                                                                    id="register-btn">Register New Subject
                                                            </button>
